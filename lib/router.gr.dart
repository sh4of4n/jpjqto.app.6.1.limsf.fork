...
class AppRouter extends _i22.RootStackRouter {
  ...
  List<_i22.RouteConfig> get routes => [
        _i22.RouteConfig(Authentication.name, path: '/'),
        _i22.RouteConfig(ClientAccount.name, path: '/client-account'),
        _i22.RouteConfig(Login.name, path: '/Login'),
        _i22.RouteConfig(ForgotPassword.name, path: '/forgot-password'),
        _i22.RouteConfig(ChangePassword.name, path: '/change-password'),
        _i22.RouteConfig(RegisterMobile.name, path: '/register-mobile'),
        _i22.RouteConfig(RegisterVerification.name,
            path: '/register-verification'),
        _i22.RouteConfig(RegisterForm.name, path: '/register-form'),
        _i22.RouteConfig(GetVehicleInfo.name, path: '/get-vehicle-info'),
        _i22.RouteConfig(Home.name, path: '/Home'),
        _i22.RouteConfig(Settings.name, path: '/Settings'),
        _i22.RouteConfig(Profile.name, path: '/Profile'),
        _i22.RouteConfig(ProfileTab.name, path: '/profile-tab'),
        _i22.RouteConfig(UpdateProfile.name, path: '/update-profile'),
        _i22.RouteConfig(RegisterUserToDi.name, path: '/register-user-to-di'),
        _i22.RouteConfig(IdentityBarcode.name, path: '/identity-barcode'),
        _i22.RouteConfig(ImageViewer.name, path: '/image-viewer'),
        _i22.RouteConfig(ComingSoon.name, path: '/coming-soon'),
        _i22.RouteConfig(StartLearning.name, path: '/start-learning'),
        _i22.RouteConfig(CriteriaList.name, path: '/criteria-list'),
        _i22.RouteConfig(RsmRpkTabs.name, path: '/rsm-rpk-tabs'),
        _i22.RouteConfig(RpkDrawer.name, path: '/rpk-drawer'),
        _i22.RouteConfig(TakeProfilePicture.name,
            path: '/take-profile-picture'),
        _i22.RouteConfig(OperatorScanQR.name, path: '/operator-scan-qR'),
        _i22.RouteConfig(LearningEnterStudentIC.name,
            path: '/learning-enter-student-iC'),
        _i22.RouteConfig(RpkCandidateDetails.name,
            path: '/rpk-candidate-details'),
        _i22.RouteConfig(RpkPartIII.name, path: '/rpk-part-ii-i'),
        _i22.RouteConfig(JrCandidateDetails.name,
            path: '/jr-candidate-details'),
        _i22.RouteConfig(JrPartIII.name, path: '/jr-part-ii-i'),
        _i22.RouteConfig(ConfirmCandidateInfo.name,
            path: '/confirm-candidate-info'),
        _i22.RouteConfig(HomeSelect.name, path: '/home-select'),
        _i22.RouteConfig(HomePageRpk.name, path: '/home-page-rpk'),
        _i22.RouteConfig(HomePageRpk.name, path: '/home-page-rpk'),
        _i22.RouteConfig(CheckListRoute.name, path: '/check-list-page'),
        _i22.RouteConfig(ChecklistHome.name, path: '/checklist-home'),
        _i22.RouteConfig(ChecklistResultRoute.name,
            path: '/checklist-result-page'),
        _i22.RouteConfig(RuleRoute.name, path: '/rule-page'),
        _i22.RouteConfig(TestRoute.name, path: '/test-page')
      ];
}
...
class GetVehicleInfo extends _i22.PageRouteInfo<GetVehicleInfoArgs> {
  GetVehicleInfo({_i23.Key? key, required String type})
...
class ImageViewer extends _i22.PageRouteInfo<ImageViewerArgs> {
  ImageViewer({String? title, _i23.NetworkImage? image})
