...
//import com.example.morpho_sample.MorphoSample;
import com.example.morpho_sample.database.DatabaseItem;
import com.example.morpho_sample.info.subtype.SecurityOption;
import com.example.morpho_sample.info.subtype.SensorWindowPosition;
...
public class ProcessInfo
{
	...
	private boolean						asyncBusyWarning					= true;
...
//	private MorphoSample				morphoSample						= null;
	...
	public boolean isAsyncBusyWarning()
	{
		return asyncBusyWarning;
	}
	
	public void setAsyncBusyWarning(boolean asyncBusyWarning)
	{		
		this.asyncBusyWarning = asyncBusyWarning;
		if (asyncBusyWarning)
		{
			callbackCmd |= CallbackMask.MORPHO_CALLBACK_BUSY_WARNING.getValue();
		}
		else
		{
			callbackCmd &= ~CallbackMask.MORPHO_CALLBACK_BUSY_WARNING.getValue();
